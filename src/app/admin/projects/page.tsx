...
export default function ManageProjects() {
  ...
  const openEditDialog = (project: Project) => {
    ...
    setEditExternalLink(project.externalLink);
  ...
  const handleUpdateProject = async () => {
    ...
    const payload = {
      ...
      techStack: editTechStack.split(",").map((item) => item.trim()),
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/projects/${editingProject.id}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
      ...
      <Dialog open={isEditing} onOpenChange={setIsEditing}>
        <DialogContent className="max-w-2xl glass-card border-white/10 max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-6 py-4">
            ...
            <AIGenerator type="project" onGenerated={setEditDescription} />
            ...
            <div className="flex justify-end gap-3 pt-4 border-t border-white/5">
              ...
              <Button className="bg-primary" onClick={handleUpdateProject}>
                Update Project
              </Button>
            </div>
          </div>
